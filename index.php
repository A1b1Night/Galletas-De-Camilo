    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 0;">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="./assets/img/galleta1.jpg" alt="slider1" width="auto">
                <div class="carousel-caption">
                    Catálogo
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/galleta2.png" alt="slider2">
                <div class="carousel-caption">
                    Nuestro Compromiso
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/galleta3.jpg" alt="slider3">
                <div class="carousel-caption">
                    Nuestras Tortas
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        ...
                        <p><a href="registration.php" class="btn btn-success btn-raised btn-block">Registrarse</a></p>   
                   </article>
                </div>

                <div class="col-xs-12 col-sm-6">
                    <img src="assets/img/galletas.png" alt="Smart-TV" class="img-responsive" style="width: 50%; display: block; margin: 0 auto;">
                </div>
            </div>
        </div>
    </section>
