...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs">
            <div class="col-xs-4">
              <a href="index.php"><p class="text-navbar tittles-pages-logo"><i class="fas fa-bone">  Galletas De Camilo</i></p></a>
            </div>
            <div class="col-xs-8">
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo"><i class="fas fa-bone">   Galletas <br>de Camilo</i></h3>
