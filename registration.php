        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-5 text-center">
                    <figure>
                      <img src="./assets/img/registro1.png" alt="store" class="img-responsive">
                    </figure>
                </div>
                <div class="col-sm-7">
                    <div id="container-form">
                       ...
                       <form class="FormCatElec" action="process/regclien.php" role="form" method="POST" data-form="save">
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-12">
                                <div class="form-group label-floating">
                                  <label class="control-label"><i class="fas fa-id-card" aria-hidden="true"></i>&nbsp; Ingrese su número de DNI</label>
                              ...
                              <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                  <label class="control-label"><i class="fas fa-at" aria-hidden="true"></i>&nbsp; Ingrese su Email</label>
                              ...
                              <div class="col-xs-12">
                                <div class="form-group label-floating">
                                  <label class="control-label"><i class="fas fa-user" aria-hidden="true"></i>&nbsp; Ingrese su nombre de usuario</label>
                          ...
                          <p><button type="submit" class="btn btn-success btn-block btn-raised">Registrarse</button></p>
                        </form> 
                    </div> 
                </div>
            </div>
