                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                ...
                                <p class="text-center text-primary">
                                    No es necesario actualizar la Imagen del producto, sin embargo si desea actualizarla seleccione una en el siguiente campo. Formato de imágenes admitido png y jpg. Tamaño máximo 5MB.
                                </p>
                            </div>
                            <div class="col-xs-12">
                                <div class="form-group">
